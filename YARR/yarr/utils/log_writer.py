    ...
    def add_scalar(self, i, name, value):
        if self._tensorboard_logging:
            try:
                ...
                print(f"Invalid step value: {i}. Skipping scalar logging.")
                return
